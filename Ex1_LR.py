...
#попробуем нормализовать данные методом min-max
...
y_min_max = (df_train['cost'] - df_train['cost'].min()) / (df_train['cost'].max() - df_train['cost'].min())  
...
print('OLS Model - MSE : ', mse_ols, 'R^2 : ', r2_ols)
print('Linear Regression Model - MSE : ', mse_lr, 'R^2 : ', r2_lr)
#после нормализации MSE в обеих моделях в пределах нормы, но R^2 очень мал, значит модели не подходят для имеющихся данных...