...
#модель ARIMA
model_auto = auto_arima(train['IPG2211A2N'], seasonal=False, trace=True)
print(model_auto.summary(), '\n')

p, d, q = model_auto.order
model_arima = ARIMA(train['IPG2211A2N'], order=(p, d, q))
...
#AutoML
data = df[['IPG2211A2N']].reset_index()
...
#Результаты AutoML заметн хуже, чем у моделей ARIMA/SARIMA, а показатель R^2<0 говорит о неприменимости модели к данным 